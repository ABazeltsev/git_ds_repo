...
#     103902: 'no'
# }
# for val in client_status:
#     if client_status[val] == 'no':
#         continue
#     else:
#         print(val)
...
## count_numbers = 5
# cnt = 0
# for key_val in mixture_dict:
#     if type(mixture_dict[key_val]) == int or type(mixture_dict[key_val]) == float:
#         print(type(mixture_dict[key_val]))
#         cnt += 1
#     else:
#         continue
# print(cnt)
